...
public class CrashHandler implements Thread.UncaughtExceptionHandler {
    public static String CRASH_DIR = Environment.getExternalStorageDirectory().getPath() + "/MxGTD/";
    public static String CRASH_LOG = CRASH_DIR + "crash.log";
    ...
    public void uncaughtException(Thread thread, Throwable throwable) {
        ...
        p.write("Error Time: " + XUtil.getTimeYMDHM(System.currentTimeMillis()) + "\n");
