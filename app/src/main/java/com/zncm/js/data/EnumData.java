...
public class EnumData {
    ...
    public enum HomeEnum {
        ...
        NONE(0, "NONE"), PROJECT(1, "分组"), REMIND(2, "提醒"), SETTING(3, "设置"), SUM(4, "统计"), VERSION(5, "版本"), DELETED(6, "已删"), FOCUS(7, "专注"), SEARCH(8, "搜索"), LIKE(9, "收藏"), ALBUM(10, "相册"), CAL(11, "日历"), TODAY(12, "回顾"), TIMELINE(13, "筛选");
        private int value;
        private String strName;
    ...
    public enum RefreshEnum {
        ...
        PROJECT(1, "project"), TASK(2, "task"), SETTING_PWD(3, "setting_pwd"), PjInfo(4, "setting_pwd");
        private int value;
        private String strName;
    ...
    public enum BusinessEnum {
        //业务类型 1-分组 2-日记本  3-清单 4-进展 5-提醒
