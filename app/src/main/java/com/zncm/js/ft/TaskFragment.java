...
//                position = position - listView.getHeaderViewsCount();
                ...
                //2015年8月31日 不显示 分组 进入日记本可以查看所属分组 简洁列表
                holder.tvTag.setVisibility(View.GONE);
...
//                });
                ...
                if (tk.getStatus() == EnumData.StatusEnum.ON.getValue()) {
                    ...
                    holder.llBg.setBackgroundColor(getResources().getColor(R.color.material_grey_400));
                }
...
//        });
    ...
    public void operate(final TaskData data) {
        final boolean isChecked = EnumData.StatusEnum.OFF.getValue() == data.getStatus();
        new MaterialDialog.Builder(ctx)
                .items(new String[]{isChecked ? "未完成" : "已完成", "重要性", "删除", "编辑"})
...
//                                new MaterialDialog.Builder(ctx)
//                                        .title("克隆日记本!")
//                                        .content("克隆日记本将会连带克隆日记本下所有的清单,确认进行克隆?")
//                                        .theme(Theme.LIGHT)
//                                        .positiveText("克隆")
//                                        .negativeText("取消")
//                                        .callback(new MaterialDialog.ButtonCallback() {
...
//                listView.setSelection(0);
    ...
    private void refresh() {
        ...
        XUtil.debug("fragment:"+projectData);
        getData(true);
    }
